public class Druides extends Gaulois {
    ...
    public Druides(String nom, int force, int nombreDeDose) {
        ...
        try { random = SecureRandom.getInstanceStrong(); 
        ...
        this.parler("J'ai concocté " + nombreDeDose +  " doses de potion magique. Elle a une force de "+ forcePotion + ".");
    }
    ...
    public void boosterGaulois(Gaulois gaulois){
        if(gulois.getnom().equals("Obélix")){
